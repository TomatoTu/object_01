...
function fetch(api,type,data={}) {
  return {
    [CALL_API]: {
      successType:type,
      endpoint: 'system/articlelist/'+api,
      data:data
    }
  }
}
...
export function loadProductList(systemId) {
  return (dispatch, getState) => {
    return dispatch(fetch('articlelistrecycle',ActionTypes.PRODUCT_LIST_LOAD_SUCCESS,{'system_id':systemId}))
  }
}
