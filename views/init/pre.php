...
use node\assets\PreAsset;

PreAsset::register($this);
?>
<!DOCTYPE html>
            ...
            <div class="preview-containt-b">
                ...
                <div class="web_view_box_b">
                    <div class="web_view_box_in scroll-box">
                            <iframe style="width:100%;height:100%;overflow-x:hidden;border:0;" src="/init/preview?theme=<?= $theme ?>&page=<?= $page ?>" seamless="seamless" id="eidtIframe">
